...
public class JwtServiceProject
{
    ...
    //{
    public class ProjectUserTocken
    {
        [Key]
    ...
    public class JwtHandlerProject
    {
        private readonly IConfiguration _configuration;
        private readonly AppDbContext _dbContext;

        public JwtHandlerProject(IConfiguration configuration, AppDbContext DBContext)
        {
        ...
        public string GenerateToken(ProjectUserTocken user)
        {
            try
            {
        ...
        public async Task<bool> ValidateToken(string token)
        {
            ...
            try
            {
                ...
                var validatetoken = new PRMMASTER_ProjectLoginSettings();
